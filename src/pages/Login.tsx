          ...
          <div className="flex bg-gray-100 rounded-lg p-1 shadow-inner">
            <button
              ...
              className={`flex-1 py-2 px-4 rounded-md text-sm font-medium transition-all duration-200 ${
                userType === "Client" ? "bg-white text-gray-900 shadow-md" : "text-gray-600 hover:text-gray-900"
              }`}
            >
              Client
            </button>
            <button
              ...
              className={`flex-1 py-2 px-4 rounded-md text-sm font-medium transition-all duration-200 ${
                userType === "Attorney" ? "bg-white text-gray-900 shadow-md" : "text-gray-600 hover:text-gray-900"
              }`}
            >
              Attorney
            </button>
